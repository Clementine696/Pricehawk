...
class ProductData:
    ...
    # Step/slab pricing: list of (min_quantity, price) tuples
    # e.g. [(1, 75.0), (2, 71.0), (3, 70.0)] means 1 unit=฿75, 2+=฿71, 3+=฿70
    step_prices: List[tuple] = field(default_factory=list)
